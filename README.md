...
python hello.py
python calc.py
python words.py   # ввод текста, завершить Ctrl+Z Enter (Windows) или передать файл
## Что умеет
- hello.py — приветствие по имени и возрасту
...
- expenses.py — учет расходов (команды: добавить расход/показать все/показать общую сумму расходов/сумма по категории/выход), сохранять в файл expenses.json
